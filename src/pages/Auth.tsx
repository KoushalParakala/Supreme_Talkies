...
export default function Auth(){
  ...
  return (
    <div style={{display:'flex',flexDirection:isMobile?'column':'row',height:'100vh',overflow:'hidden',background:'#0e0f13'}}>
      ...
      <motion.div data-lenis-prevent initial={{opacity:0,x:isMobile?0:40}} animate={{opacity:1,x:0}} transition={{duration:0.9,ease:[0.25,0.1,0.25,1]}}
        style={{flex:1,background:'#13141a',display:'flex',flexDirection:'column',justifyContent:isMobile?'flex-start':'flex-start',padding:isMobile?'clamp(24px,4vw,48px)':'clamp(32px,5vw,72px)',paddingTop:isMobile?80:undefined,position:'relative',overflowY:'auto'}}>
