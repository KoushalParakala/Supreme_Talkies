    ...
    >
      ...
      >
        {FILMS.map((film, i) => {
          ...
          // prefer the dynamic posterImage field if added, fallback to static scrolls for the first 5
          // if it's a new film without a poster image, fallback to its first still or reelImage
          const bgImage = film.posterImage || (i < 5 ? `/scroll${i + 1}.webp` : (film.stills && film.stills.length > 0 ? film.stills[0] : film.reelImage));
